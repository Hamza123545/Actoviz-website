...
- **Customer Success:** Your success is our priority. We work closely with clients to ensure they maximize the value of our software solutions and achieve their business goals.""",
    ...
    "lms_solution": {
        ...
        "content": "Our LMS is a complete e-learning platform for educational institutions and corporate training needs. Features include course creation and management, student progress tracking, assessment tools, and video conferencing integration. Perfect for schools, universities, and companies looking to deliver comprehensive training programs.",
        "keywords": ["lms", "learning management system", "e-learning", "education", "training", "courses"]
    },
    "calling_dialer": {
        "title": "International Calling Dialer",
        "content": "Our professional calling solution provides global communication with advanced features. Includes global calling capabilities, call recording and analytics, CRM integration, and multi-language support. Ideal for sales teams, customer service, and international business communications.",
        "keywords": ["calling dialer", "international calling", "phone system", "crm integration", "call recording"]
    },
    "ai_chatbot": {
        "title": "Custom Chatbot AI Integrations",
        "content": "Our intelligent conversational AI solutions are tailored to your business needs. Features include Natural Language Processing, Multi-platform Integration, Custom Training Models, and Real-time Analytics. Perfect for customer support, lead generation, and automated business processes.",
        "keywords": ["ai chatbot", "artificial intelligence", "conversational ai", "customer support", "automation"]
    },
    "web_development": {
        "title": "Web Development",
        "content": "We create modern, responsive websites built with cutting-edge technologies. Our web development services include Responsive Design, SEO Optimization, Fast Loading Speed, and Content Management System. We build websites that not only captivate your audience but also convert visitors into loyal customers.",
        "keywords": ["web development", "website", "responsive design", "seo", "cms"]
    },
    "pricing": {
        "title": "Pricing & Subscription Plans",
        "content": "Our software rental model offers flexible pricing with no upfront costs. Here are our main pricing options:\n\n**Learning Management System (LMS):**\n- Basic Plan: $99/month (up to 100 users)\n- Professional Plan: $199/month (up to 500 users)\n- Enterprise Plan: $399/month (unlimited users)\n\n**International Calling Dialer:**\n- Starter Plan: $79/month (up to 5 agents)\n- Business Plan: $149/month (up to 25 agents)\n- Enterprise Plan: $299/month (unlimited agents)\n\n**AI Chatbot Integration:**\n- Basic: $49/month (up to 1,000 conversations)\n- Professional: $99/month (up to 10,000 conversations)\n- Enterprise: $199/month (unlimited conversations)\n\n**Web Development:**\n- Custom pricing based on project requirements\n- Starting from $2,999 for basic websites\n- Enterprise solutions available\n\nAll plans include 24/7 technical support, automatic updates, and free consultation. Annual subscriptions receive 20% discount. Contact us at info@actoviz.com for custom enterprise solutions.",
        "keywords": ["pricing", "subscription", "cost", "plans", "rental model", "no upfront cost", "lms pricing", "calling dialer pricing", "chatbot pricing", "web development pricing"]
    },
    "contact": {
        "title": "Contact Information",
        "content": "You can reach us via email at **info@actoviz.com** or visit our website at **actoviz.com** for more information. We also offer free consultations to help you choose the right software solutions for your business needs.",
        "keywords": ["contact", "email", "reach us", "get in touch", "consultation"]
    },
    "website": {
    ...
    "support": {
        ...
        "content": "We provide comprehensive onboarding, training materials, and 24/7 technical support to ensure you get the most out of our software solutions. Our support team is always available to help with setup, configuration, and any technical issues you may encounter.",
        "keywords": ["support", "help", "training", "24/7", "technical support", "onboarding"]
    },
    "getting_started": {
            ...
            "properties": {
                ...
                "category": {
                    ...
                    "enum": [
                        ...
                        "website", "consultation", "support", "getting_started", "rental_model"
                    ],
