...
const data___customweb = {
    hero: {
      ...
      body: (
        <>
          We are crafting unique websites for your specific needs. Actoviz
      ...
      body: {
        para: (
          <>
            ...
            Actoviz offers special deals on custom web development services
    ...
    whyWeAndWhatWeDo: {
      ...
      body: {
        para: (
          <>
            At Actoviz, we&apos;re committed to empowering your digital
        ...
        benefits: [
          ...
          },
          {
            ...
            paragraph: (
              <>
                Actoviz websites are equipped with advanced features and
          ...
          },
          {
            ...
            paragraph: (
              <>
                Actoviz utilizes AWS(Amazon Web Services), Vercel, and
    ...
    faq: {
      ...
      faqs: [
        ...
        },
        {
          id: 2,
          question: (
            <>What technologies does Actoviz use for web development?</>
          ),
          answer: (
            <>
              Actoviz uses state-of-the-art technologies including core
        ...
        },
        {
          id: 3,
          question: (
            <>Are you able to have Actoviz rework my current website?</>
          ),
          answer: (
            <>
              To improve the look, feel, and general user experience of
              websites, Actoviz does offer website redesign services.
            </>
          ),
        },
        {
          ...
          answer: (
            <>
              Project complexity affects timelines, but Actoviz guarantees
        ...
        {
          id: 5,
          question: <>Does Actoviz Provide ongoing website maintenance</>,
          answer: (
            <>
              To guarantee that your website is current and safe, Actoviz
