...
const data___shopify = {
    hero: {
      video: "https://https://www.youtube.com/embed/o2lfsiE2PEg?si=TjLtbHMIhOM_rBB2/embed/wBliKrwi59s?si=7307wRLRTV8B6YtK",
      ...
      body: (
        <>
          Actoviz offers expert Shopify development services to help
      ...
      body: {
        para: (
          <>
            ...
            growth in <CurrentYear />. Are you ready to join them? At The Actoviz,
    ...
    whyWeAndWhatWeDo: {
      ...
      body: {
        para: (
          <>
            At Actoviz, we understand the complexity involved in launching an
    ...
    faq: {
      ...
      faqs: [
        ...
        },
        {
          ...
          question: (
            <>
              Is it possible for Actoviz to move my current store to Shopify?
            </>
          ),
          answer: (
            <>
              Absolutely, Actoviz makes migrating to the Shopify platform
        ...
        },
        {
          id: 3,
          question: (
            <>What features can Actoviz integrate into my Shopify store?</>
          ),
          answer: (
            <>
              Actoviz can improve your Shopify store by integrating features
        ...
        },
        {
          id: 4,
          question: (
            <>Can Actoviz help my Shopify store with continuous support?</>
          ),
          answer: (
            <>
              Of course, Actoviz provides continuous assistance to make sure
        ...
        },
        {
          ...
          answer: (
            <>
              Project scope determines timelines, but Actoviz prioritizes
