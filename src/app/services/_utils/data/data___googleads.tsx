...
const data___googleads = {
    hero: {
      video: "https://https://www.youtube.com/embed/o2lfsiE2PEg?si=TjLtbHMIhOM_rBB2/embed/S8rncQvo-nU?si=JrIKuomxaHXBotUT",
      ...
      body: (
        <>
          ...
          in <CurrentYear />... Are you ready to join them? At The Actoviz, Take your
    ...
    whyWeAndWhatWeDo: {
      tagline: <>Actoviz Google Ads Service</>,
      title: (
        <>
    ...
    userEmpathy: {
      ...
      title: (
        <>
          ...
          Actoviz, that&apos;s perfectly okay. We understand the natural
          reservations.
        </>
      ),
      body: (
        <>
          ...
          don&apos;t ask for blind belief at The Actoviz. We offer results.
        </>
      ),
    },
    coreBenefits: {
      ...
      title: (
        <>
          ...
          <span>Part Of The Actoviz Family</span>
        </>
      ),
      body: {
        para: (
          <>
            ...
            Joining Actoviz Google Ads Family goes beyond powerful
    ...
    endingFunnel: {
      ...
      body: (
        <>
          Spots for The Actoviz&apos;s Google Ads Family are filling up
    ...
    faq: {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: (
            <>
              Actoviz does provide optimization services to improve the
