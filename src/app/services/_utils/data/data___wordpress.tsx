...
const data___wordpress = {
    hero: {
      video: "https://https://www.youtube.com/embed/o2lfsiE2PEg?si=TjLtbHMIhOM_rBB2/embed/2aM1vvkqalY?si=74fkvuCAFbHz7OkG",
      ...
      body: (
        <>
          <span>
            Actoviz offers expert WordPress Development services to help
      ...
      body: {
        para: (
          <>
            ...
            deals on WordPress development services from Actoviz. Our team is
    ...
    whyWeAndWhatWeDo: {
      ...
      body: {
        para: (
          <>
            At Actoviz, we&apos;re passionate about WordPress and its
    ...
    faq: {
      ...
      faqs: [
        ...
        {
          id: 2,
          question: <>Does Actoviz offer Wordpress theme customization?</>,
          answer: (
            <>
              Actoviz does theme customization so that your wordpress website
        ...
        },
        {
          id: 3,
          question: (
            <>Does Actoviz provide Wordpress e-commerce solutions?</>
          ),
          answer: (
            <>
              Yes, Actoviz offers reliable e-commerce solutions. It
        ...
        },
        {
          ...
          answer: (
            <>
              Actoviz quickly moves content and functionality from other
        ...
        {
          id: 5,
          question: <>Why does Actoviz use Wordpess security measures?</>,
          answer: (
            <>
              To proect your Wordpress website from possible attacks, Actoviz
