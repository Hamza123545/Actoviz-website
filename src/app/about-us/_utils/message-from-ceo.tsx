  ...
  googleads: {
    ...
    title: (
      <>
        ...
        <span>thanks on considering Actoviz</span>
    ...
    paragraphs: [
      <>
        ...
        mind:
        <span>
          Is Actoviz the right fit for me? Can my business truly achieve
      ...
      <>
        <span>But here&apos;s the thing: </span> Actoviz is built to take the
      ...
      <>
        ...
        letting Actoviz handle their Google Ads. Their success stories can be
        your inspiration!
      </>,
      <>
        Watch the video, and then fill out that application with a surge of
        confidence! Actoviz is designed for YOU, and we&apos;re here to help
        you succeed.
      </>,
      <>
  ...
  googleanalytics: {
    ...
    paragraphs: [
      ...
      <>
        ...
        It features real businesses, just like yours, who saw amazing results by
        letting Actoviz handle their Google Analytics. Their success stories
  ...
  socialmediapaidads: {
    ...
    paragraphs: [
      ...
      <>
        ...
        It features real businesses, just like yours, who saw amazing results by
        letting Actoviz handle their Social Media Paid Ads. Their success
  ...
  uiux: {
    ...
    paragraphs: [
      ...
      <>
        ...
        It features real businesses, just like yours, who saw amazing results by
        letting Actoviz handle their UI/UX. Their success stories can be your
        inspiration!
      </>,
      <>
        Watch the video, and then fill out that application with a surge of
  ...
  customwebdev: {
    ...
    paragraphs: [
      ...
      <>
        ...
        It features real businesses, just like yours, who saw amazing results by
        letting Actoviz handle their Custom Web Development. Their success
        stories can be your inspiration!
      </>,
      <>
        Watch the video, and then fill out that application with a surge of
  ...
  software: {
    ...
    paragraphs: [
      ...
      <>
        ...
        It features real businesses, just like yours, who saw amazing results by
        letting Actoviz handle their Software Development. Their success
        stories can be your inspiration!
      </>,
      <>
        Watch the video, and then fill out that application with a surge of
  ...
  wordpress: {
    ...
    paragraphs: [
      ...
      <>
        ...
        It features real businesses, just like yours, who saw amazing results by
        letting Actoviz handle their Wordpress Development. Their success
        stories can be your inspiration!
      </>,
      <>
        Watch the video, and then fill out that application with a surge of
  ...
  shopify: {
    ...
    paragraphs: [
      ...
      <>
        ...
        It features real businesses, just like yours, who saw amazing results by
        letting Actoviz handle their Shopify Development. Their success
        stories can be your inspiration!
      </>,
      <>
        Watch the video, and then fill out that application with a surge of
