        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            {painPoints.map((point, index) => (
              <div key={`pain-point-${index}-${point.substring(0, 20).toLowerCase().replace(/\s+/g, '-')}`} className="flex items-start gap-3">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            {solutions.map((solution, index) => (
              <div key={`solution-${index}-${solution.substring(0, 20).toLowerCase().replace(/\s+/g, '-')}`} className="flex items-start gap-3">
