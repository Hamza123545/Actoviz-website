...
const ExpireSection = () => {
  ...
  const [time, setTime] = useState(() => {
    if (typeof window === "undefined") {
      return calculateTimeLeft(new Date(OfferDateString));
    }
    return calculateTimeLeft(getTargetDate());
  });
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2">
            <iframe
              ...
              src="https://www.youtube.com/embed/o2lfsiE2PEg?si=TjLtbHMIhOM_rBB2"
