        ...
        <div className="max-w-2xl space-y-8">
          ...
          <div className="space-y-6">
            {leftFeatures.map((feature, index) => (
              <div key={feature.id} className="flex items-start gap-3 [&>svg]:w-6 [&>svg]:h-6 [&>svg]:min-w-6 [&>svg]:min-h-6 [&>svg]:stroke-secondary">
                {feature.icon}
