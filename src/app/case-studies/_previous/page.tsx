                        ...
                        <div className="flex flex-col items-start justify-start gap-[15px]">
                          ...
                          <ul className="flex flex-col gap-[10px]">
                            {after.map((li: any, index: number) => {
                              return (
                                <li
                                  key={`after-${index}-${typeof li === 'string' ? li.substring(0, 20) : 'content'}`}
                      ...
                      <div className="flex flex-col items-center justify-center small-gap py-5 w-full">
                        {item?.footerParagraphs.map(
                          (para: any, index: number) => {
                            return (
                              <p key={`footer-para-${index}-${typeof para === 'string' ? para.substring(0, 20) : 'content'}`} className="text-center">
                                {para}
                              </p>
                            );
                          }
  ...
  studies: [
    {
      ...
      followup: (
        <>
          Actoviz took center stage, crafting a crescendo of engagement
    ...
    },
    {
      ...
      followup: (
        <>
          Actoviz stepped into the frame, orchestrating a symphony of
  ...
  studies: [
    {
      ...
      followup: (
        <>
          Actovizs dove into the data ocean, unravelling the complexities.
      ...
      footerParagraphs: [
        ...
        <>
          Use Actoviz to transform your data insights. Find out how we can
    ...
    },
    {
      ...
      followup: (
        <>
          Actoviz picked up the analytics brush, painting a masterpiece of
      ...
      footerParagraphs: [
        ...
        <>Join Actoviz on a data-driven adventure. </>,
      ],
    },
    {
      id: 3,
      ...
      followup: (
        <>
          Actoviz stepped into the digital age, implementing Google Tag
      ...
      footerParagraphs: [
        ...
        <>
          Embark on a data-driven journey with Actoviz. Explore Event
          Tracking Solutions
        </>,
      ],
    },
    {
      ...
      followup: (
        <>
          Enter Actoviz and Google Looker Studio, a partnership
      ...
      footerParagraphs: [
        ...
        <>
          Experience the power of visual insights with Actoviz. Unlock Looker
          Studio Solutions
        </>,
      ],
    },
  ...
  studies: [
    {
      ...
      followupH: <>Actoviz&apos;s Craft:</>,
      followup: (
        <>
          Actoviz tackled this by creating a fantastic online haven. We made
      ...
      footerParagraphs: [
        ...
        <>
          Make your place online better with Actoviz. Unlock Shopify
          Brilliance
        </>,
      ],
    },
    {
      ...
      followupH: <>Actoviz Artistry</>,
      followup: (
        <>
          Actoviz created an immersive dreamland for furniture lovers. We
      ...
      footerParagraphs: [
        ...
        <>
          Make your furniture dreams come true with Actoviz. Unlock Shopify
          Brilliance
        </>,
      ],
    },
    {
      ...
      followupH: <>Actoviz&apos;s Creative Spark</>,
      followup: (
        <>
          Actoviz brought out the creativity in New Sun Designs. We made
      ...
      footerParagraphs: [
        ...
        <>
          Show off your creativity with Actoviz. Unlock Shopify Brilliance
        </>,
      ],
    },
    {
      ...
      followupH: <>Actoviz&apos;s Brightening</>,
      followup: (
        <>
          Actoviz made The New Man Gallery&apos;s online space better. We
      ...
      footerParagraphs: [
        ...
        <>
          Make your online art gallery better with Actoviz. Unlock Shopify
          Brilliance
        </>,
      ],
    },
  ...
  studies: [
    {
      ...
      brand: "How Actoviz Supercharged Wildly Boutique's Social Media",
      title: <></>,
      challenge: (
        <>
      ...
      after: [
        ...
        <>
          <span>Happy Words from Wildly Boutique</span> &quot;Actoviz made
    ...
    },
    {
      ...
      after: [
        ...
        <>
          ...
          &quot;Actoviz did amazing things for our business. We got more
    ...
    },
    {
      ...
      after: [
        ...
        <>
          <span>Happy Words from Floganza Dubai</span>&quot;Actoviz changed
    ...
    },
    {
      ...
      after: [
        ...
        <>
          <span>Happy Words from Photoshoot Dubai Escape</span> &quot;Actoviz
  ...
  studies: [
    {
      ...
      followupH: <>Actoviz&apos;s Strategic Intervention:</>,
      followup: (
        <>
