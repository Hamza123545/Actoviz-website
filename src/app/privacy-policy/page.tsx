  ...
  return (
    <div className="container section">
      ...
      <section className="mb-8">
        ...
        <p>
          Welcome to Actoviz, your trusted software rental platform. This Privacy
      ...
      <section className="mb-8">
        ...
        <p>
          At Actoviz, we recognize and prioritize the importance of your
          privacy.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6">
          ...
          <li>Usage Data: How you interact with our LMS and calling software.</li>
          <li>Subscription Data: Billing information and service preferences.</li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6">
          <li>Providing and maintaining our LMS and calling software rental services.</li>
          <li>Improving and customizing user experiences.</li>
          <li>Sending service updates and billing communications.</li>
      ...
      <section className="mb-8">
        ...
        <p>
          ...
          provide personalized software recommendations. You
      ...
      <section className="mb-8">
        ...
        <p>
          Actoviz operates under applicable laws in the United States.
        </p>
      </section>
